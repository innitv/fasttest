...
> = {
   ...
   */
  subscription_card: {
    // Подписка уже подключена, оплачивается ОЧЕРЕДНОЙ счёт: возвращаются к
    // её карточке, а не «в приложение».
    returnLabel: "Вернуться к подписке",
    paidTitle: "Счёт оплачен",
    paymentPurpose: "Оплата подписки",
    summaryDetail: "Счёт по подписке",
  },
  booking_payment: {
    // Бронь уже создана, платёж закрывает её оформление: возвращаются к
    // самой брони, а не «в магазин».
    returnLabel: "Вернуться к брони",
    paidTitle: "Бронь оплачена",
    paymentPurpose: "Оплата тура",
    summaryDetail: "Бронь тура",
  },
  subscription_bind: {

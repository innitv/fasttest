...
export const tenantSchema = z.object({
  ...
  density: z.object({
    ...
    method_button_height: clamped(
      ...
      44,
      /*
       * Потолок поднят 60 → 64 по тому же принципу, что у соседнего поля:
       * нижняя граница наша (зона нажатия), верхняя — донорская. У EWA
       * карточка способа оплаты 63 px, и прежний потолок срезал её молча —
       * тема проходила валидацию, а карточка выходила на 3 px ниже донорской.
       */
      64,
      "44 — нижняя граница зоны нажатия",

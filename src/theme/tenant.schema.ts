    ...
    plans: z
      .array(
        z.object({
          ...
          /**
           * Состав тарифа переключателями, а не списком: у донора каждый
           * тариф показывает ОДИН И ТОТ ЖЕ набор возможностей, и разницу
           * между тарифами несёт положение тумблера. Список только
           * включённого эту разницу прячет — сравнивать становится нечем.
           */
          features: z
            .array(
              z.object({

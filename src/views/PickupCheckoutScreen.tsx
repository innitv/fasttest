      ...
      */}
      <div
        ...
        style={{
          ...
          // страницы. У донора она 28 px (лист с 85 при шапке 57), но там
          // в ней висит кнопка закрытия; кнопку сняли решением владельца,
          // и полоса осталась пустой — сокращена до намёка на слой под
          // листом. Ноль ставить нельзя: без полосы лист читается страницей,
          // а не шторкой.
          marginTop: "12px",
